CREATE OR REPLACE TRIGGER C_INT_CONSUMER_CONTATO_TRG
   FOR INSERT OR UPDATE OR DELETE ON COMM_METHOD_TAB
   COMPOUND TRIGGER
      ...
      TYPE rec_type IS RECORD (codigoCliente_ COMM_METHOD_TAB.IDENTITY%TYPE,
      ...
      AFTER EACH ROW IS
         ...
         EXCEPTION
             WHEN OTHERS THEN
                msg_erro_ := 'ERROR  TRIGGER - C_INT_CONSUMER_CONTATO_TRG: '|| substr(sqlerrm,1,1600);
      ...
      END AFTER STATEMENT;
END C_INT_CONSUMER_CONTATO_TRG;
